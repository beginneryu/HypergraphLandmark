...
def parse_args():
    ...
    new_parser.add_argument('--proj_path',  type=str, default='/media/lidelong/HIKSEMI/FC/')
    ...
    new_parser.add_argument('--data_path',  type=str, default='/media/lidelong/HIKSEMI/FC/echo-stgnet-main/Data/camus_4ch')
